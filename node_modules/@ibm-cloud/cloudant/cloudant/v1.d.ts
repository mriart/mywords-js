...
declare class CloudantV1 extends CloudantBaseService {
     ...
     */
    getGeo(params: CloudantV1.GetGeoParams): Promise<CloudantV1.Response<CloudantV1.GeoResult>>;
    /**
     ...
     * @returns {Promise<CloudantV1.Response<NodeJS.ReadableStream>>}
     */
    getGeoAsStream(params: CloudantV1.GetGeoAsStreamParams): Promise<CloudantV1.Response<NodeJS.ReadableStream>>;
    /**
     ...
     * @returns {Promise<CloudantV1.Response<CloudantV1.Ok>>}
     */
    postGeoCleanup(params: CloudantV1.PostGeoCleanupParams): Promise<CloudantV1.Response<CloudantV1.Ok>>;
    /**
     ...
     */
    getGeoIndexInformation(params: CloudantV1.GetGeoIndexInformationParams): Promise<CloudantV1.Response<CloudantV1.GeoIndexInformation>>;
    /*************************
     * replication
     ************************/
    /**
...
declare namespace CloudantV1 {
    ...
    interface GetGeoAsStreamParams {
        /** Path parameter to specify the database name. */
        db: string;
        /** Path parameter to specify the design document name. The design document name is the design document ID
         *  excluding the `_design/` prefix.
    ...
    namespace GetGeoAsStreamConstants {
        /** Query parameter that causes the geospatial query output to be returned in the specified format. */
        enum Format {
            LEGACY = "legacy",
            GEOJSON = "geojson",
    ...
    interface PostGeoCleanupParams {
        /** Path parameter to specify the database name. */
        db: string;
        headers?: OutgoingHttpHeaders;
    }
    /** Parameters for the `getGeoIndexInformation` operation. */
    interface GetGeoIndexInformationParams {
        /** Path parameter to specify the database name. */
        db: string;
        /** Path parameter to specify the design document name. The design document name is the design document ID
         *  excluding the `_design/` prefix.
    ...
    /** Schema for a GeoJSON geometry object. */
    interface GeoJsonGeometryObject {
    }
    ...
    /** Schema for a GeoJSON geometry. */
    interface GeoJsonGeometry extends GeoJsonGeometryObject {
    ...
    interface GeoJsonGeometryCollection extends GeoJsonGeometryObject {
        /** The type of GeoJSON Geometry. */
        type: string;
